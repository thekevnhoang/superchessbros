...
socket.on('play', function (msg) {
    if (msg == roomId) {
        play = false;
        state.innerHTML = "Let the battle begin!"
...
var onDragStart = function (source, piece) {
    ...
    if (game.game_over() === true || play ||
        ...
        (game.turn() === 'w' && color === 'trainer') ||
        (game.turn() === 'b' && color === 'mario') ) {
            return false;
    }
...
socket.on('player', (msg) => {
    ...
    plno.innerHTML = 'Player ' + msg.players;
    players = msg.players;
    ...
    if(players == 2){
        ...
        state.innerHTML = "Waiting for opponent...";
